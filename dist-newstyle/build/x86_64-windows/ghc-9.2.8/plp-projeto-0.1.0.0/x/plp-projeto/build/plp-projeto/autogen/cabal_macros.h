...
/* package plp-projeto-0.1.0.0 */
#ifndef VERSION_plp_projeto
#define VERSION_plp_projeto "0.1.0.0"
#endif /* VERSION_plp_projeto */
#ifndef MIN_VERSION_plp_projeto
#define MIN_VERSION_plp_projeto(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_plp_projeto */
...
#define CURRENT_COMPONENT_ID "plp-projeto-0.1.0.0-inplace-plp-projeto"
